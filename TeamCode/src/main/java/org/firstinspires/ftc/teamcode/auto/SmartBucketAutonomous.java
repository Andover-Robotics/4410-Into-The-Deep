...
@Config
@Autonomous(name = "Smart Bucket Autonomous", group = "Autonomous")
public class SmartBucketAutonomous extends LinearOpMode {
    Bot bot;
...
//                .splineToLinearHeading(new Pose2d(new Vector2d(20, 2), Math.toRadians(180)), Math.toRadians(180), drive.defaultVelConstraint, new ProfileAccelConstraint(-70, 350))
        ...
        Actions.runBlocking(
                new ActionHelpersJava.RaceParallelCommand(
                        ...
                        new SequentialAction(
                                bot.actionDetect(),
                                drive.actionBuilder(new Pose2d(46.5, 45, Math.toRadians(-90)))
                                        .strafeToConstantHeading(new Vector2d(46.5 - Bot.sampleYPos, 45))
                                        .stopAndAdd(new SequentialAction(
