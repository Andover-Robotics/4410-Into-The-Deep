...
public class Arm {
    ...
    public double pitchGroundPickup = -95, pitchWallPickup = 180, pitchFrontPickupToStorage = -55, pitchRearPickupToStorage = -142, pitchStorage = -110, pitchOuttakeUp = 80, pitchOuttakeDown = 70, pitchBucketUp = 135, pitchBucketDown = 165, pitchChamberHoriz = -0, pitchOuttakeHoriz = 0;
