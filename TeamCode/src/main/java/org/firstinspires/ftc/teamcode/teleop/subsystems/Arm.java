...
public class Arm {
    ...
    public double pitchGroundPickup = -95, pitchWallPickup = 186, pitchFrontPickupToStorage = -55, pitchRearPickupToStorage = -142, pitchStorage = -110, pitchOuttakeUp = 80, pitchOuttakeDown = 70, pitchBucket = 120, pitchBucketDown = 165, pitchChamberHoriz = -0, pitchOuttakeHoriz = 0;
