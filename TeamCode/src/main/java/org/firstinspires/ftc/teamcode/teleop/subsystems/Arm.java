...
public class Arm {
    ...
    public double pitchGroundPickup = -90, pitchWallPickup = 180, pitchFrontPickupToStorage = -45, pitchRearPickupToStorage = -135, pitchStorage = -110, pitchOuttakeUp = 60, pitchOuttakeDown = -35, pitchBucket = 170, pitchOuttakeHoriz = 0;
