 ...
 */
public class TeleMecanumDrive extends RobotDrive {
     ...
     */
    public TeleMecanumDrive(Motor frontLeft, Motor frontRight, Motor backLeft, Motor backRight) {
     ...
     * @param backRight  the back right motor
     */
    public TeleMecanumDrive(boolean autoInvert, Motor frontLeft, Motor frontRight, Motor backLeft, Motor backRight) {
